...
const PrimaUmeraPage: React.FC = () => {
  ...
  const seoTitle = t('prima_umera_title');
  const seoDescription = t('prima_umera_seo_description'); // TODO: Přidat do lokalizace
  const formula = t('prima_umera_formula');
  const explanation = t('prima_umera_explanation'); // TODO: Přidat do lokalizace
  const examples = [
    // Příklady
  ];
  const relatedCalculators = [ // TODO: Přidat dle relevance
    { name: t('neprima_umera_title'), href: '/calculator/trojclenka/neprima-umera' }
