...
const PrimaUmeraCalculator: React.FC = () => {
  ...
  return (
    <div className="p-4 border rounded shadow-md">
      <h2 className="text-xl font-semibold mb-4">{t('prima_umera_title')}</h2>
      <p className="mb-4">{t('prima_umera_description')}</p>
