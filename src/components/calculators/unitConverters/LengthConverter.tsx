...
const LengthConverter: React.FC = () => {
  ...
  const handleConversion = () => {
    ...
    if (!isNaN(numInputValue)) {
      const valueInMeters = numInputValue * conversionFactors[inputUnit];
      const convertedValue = valueInMeters / conversionFactors[outputUnit];
  ...
  return (
    <div>
      <h3 className="text-lg font-semibold mb-2">{t('length_converter_title')}</h3>
